...
public class CheckIsLearningServlet extends HttpServlet {
	SubjectService service = SubjectService.getInstance();
	/**
	 * Constructor of the object.
	 */
	public CheckIsLearningServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean learning = service.checkLearning(id,cid);
		out.write(GsonUtil.toJson(new Result(0, learning)));
		out.flush();
		out.close();
	}
