...
public class CourseInfoRevise extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CourseInfoRevise() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UniversalResult universalResult=courseService.courseInfoReviseInService(majorTitle,newMap, id);
		Gson gson=new Gson();
