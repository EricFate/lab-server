...
public class GetLessonVideo extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetLessonVideo() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetVideoResult getVideoResult=lessonService.getLessonVideoInService(id);
		PrintWriter out = response.getWriter();
		out.print(GsonUtil.toJson(getVideoResult));
		out.flush();
		out.close();
	}
