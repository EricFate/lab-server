...
public class CreateMyClass extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public CreateMyClass() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UniversalResult universalResult = teacherService.createClassInService(token, gradeString, classNum);
		Gson gson=new Gson();
