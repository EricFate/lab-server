...
public class TeacherInfoRevise extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TeacherInfoRevise() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UniversalResult universalResult=teacherService.teacherInfoReviseInService(map, id);
		Gson gson=new Gson();
