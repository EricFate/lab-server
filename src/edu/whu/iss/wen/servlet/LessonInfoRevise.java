...
public class LessonInfoRevise extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public LessonInfoRevise() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UniversalResult universalResult=lessonService.lessonInfoReviseInService(map, id);
