...
public class MultipleChoicesExerciseImageUpload extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public MultipleChoicesExerciseImageUpload() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			imageResult=teacherService.multipleChoicesExerciseImageUpload(uid, imageURL);
